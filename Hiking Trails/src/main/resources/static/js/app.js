(function() {
	...
	app.config(function($stateProvider, $urlRouterProvider, $controllerProvider){
		...
		$stateProvider
			...
			.state('trails',{
	        url:'/trails',
	        templateUrl: viewsPrefix + 'trails.html',
	        controller:'TrailListController'
	    }).state('viewTrail',{
	       url:'/trails/:id/view',
	       templateUrl: viewsPrefix + 'trail-view.html',
	       controller:'TrailViewController'
	    }).state('newTrail',{
	        url:'/trails/new',
	        templateUrl: viewsPrefix + 'trail-add.html',
	        controller:'TrailCreateController'
	    }).state('editTrail',{
	        url:'/trails/:id/edit',
	        templateUrl: viewsPrefix + 'trail-edit.html',
	        controller:'TrailEditController'
	    })
	})
